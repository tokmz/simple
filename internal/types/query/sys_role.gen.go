...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.DefaultRouter = field.NewString(tableName, "default_router")
...
type role struct {
	...
	Name          field.String // 角色名称|Role name
	Code          field.String // 角色编码|Role code
	DefaultRouter field.String // 默认的路由|Default router
...
func (r *role) updateTableName(table string) *role {
	...
	r.DefaultRouter = field.NewString(table, "default_router")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["default_router"] = r.DefaultRouter
